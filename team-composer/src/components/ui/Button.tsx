...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary: 'btn-save bg-blue-700 text-white hover:bg-blue-600 disabled:bg-slate-700 disabled:text-slate-500 disabled:hover:bg-slate-700',
  secondary: 'btn-reset bg-slate-700 text-slate-200 hover:bg-slate-600',
  auto: 'btn-auto bg-teal-600 text-white hover:bg-teal-700',
  improve: 'btn-improve bg-violet-600 text-white hover:bg-violet-700',
  danger: 'text-red-400 hover:bg-red-950/60',
  ghost: 'border border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700',
};
